...
makeChannelSegments c@(Channel _ _ _ msgsize slots _) =
    ...
    where
        ...
        buffer_segment = Segment (channelBufferSegmentName c) buffer_size
        reader_segment = Segment (channelReaderSegmentName c) 4
        writer_segment = Segment (channelWriterSegmentName c) 4
